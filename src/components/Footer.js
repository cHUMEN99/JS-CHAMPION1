    ...
    return (
        <footer className="footer">
            ...
            <div className="bottom">
                ...
                <p>Secure payments <a href={sulka} target="_blank" rel="noopener noreferrer"><img style={{height:'50px', width:'50px'}} src={`${process.env.PUBLIC_URL}/img/maps-svgr.svg`} alt="Google Maps" /></a></p>
            </div>
        </footer>
    );
}
